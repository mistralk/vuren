...
public:
    RasterizationPipeline(VulkanContext *pContext, vk::DescriptorSetLayout descriptorSetLayout,
...
public:
    RayTracingPipeline(VulkanContext *pContext, vk::DescriptorSetLayout descriptorSetLayout,

...
RasterizationPipeline::RasterizationPipeline(VulkanContext *pContext, vk::DescriptorSetLayout descriptorSetLayout,
...
void RasterizationPipeline::setup() {
    ...
    vk::PipelineRasterizationStateCreateInfo rasterizer{ .depthClampEnable        = VK_FALSE,
                                                         ...
                                                         .cullMode                = m_rasterProperties.isBiltPass
    ...
    std::vector<vk::PipelineColorBlendAttachmentState> colorBlendAttachments(m_rasterProperties.colorAttachmentCount,
...
RayTracingPipeline::RayTracingPipeline(VulkanContext *pContext, vk::DescriptorSetLayout descriptorSetLayout,
